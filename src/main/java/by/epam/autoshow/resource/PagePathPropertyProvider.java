...
public final class PagePathPropertyProvider {
    ...
    public static final String USER_EDIT_FORM_PROPERTY = "path.page.userEditForm";

    public static final String SERVICE_OVERVIEW_PAGE_PROPERTY = "path.page.serviceOverview";
    public static final String SERVICE_EDIT_FORM_PROPERTY = "path.page.serviceEditForm";

    public static final String ORDER_OVERVIEW_PAGE_PROPERTY = "path.page.orderOverview";
    public static final String ORDER_EDIT_FORM_PROPERTY = "path.page.orderForm";

    public static final String CUSTOMER_OVERVIEW_PAGE_PROPERTY = "path.page.customerOverview";
    public static final String CUSTOMER_EDIT_FORM_PROPERTY = "path.page.customerEditForm";
}